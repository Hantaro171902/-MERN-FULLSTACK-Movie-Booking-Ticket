    ...
    <div className='fixed top-0 left-0 z-50 w-full flex items-center 
      ...
      <Link to="/" className='max-md:flex-1'>
			...
			<div className='max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium max-md:text-lg
											z-50 flex flex-col md:flex-row items-center max-md:justify-center gap-8 min-md:px-8 
											py-3 max-md:h-screen min-md:rounded-full backdrop-blur bg-black/70 md:bg-white/10 
			...
			<div className='flex items-center gap-8'>
				...
				hover:bg-primary-dull cursor-pointer transition rounded-full font-medium'>Login</button>

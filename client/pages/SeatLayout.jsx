...
const SeatLayout = () => {
  ...
  return show ? (
    <div className='flex flex-col md:flex-rpw px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      {/* {Available Timing} */}
      <div className='w-60 bg-primary/10 border border-primary/20 
                      rounded-lg py-10 h-max mmd:sticky md:top-30'>
